...
module.exports = (_a = /** @class */ (function (_super) {
        ...
        function CTL_RT_H1_RYRS() {
            ...
            _this.addPoint(new meta_1.DeviceField("de_bushuibengzhubei", 49, 2, "给水泵", 0, CTL_RT_H1_RYRS.coms_master));
            _this.addPoint(new meta_1.DeviceField("de_bushuibengshoudongzidong", 49, 2, "给水泵", 1, CTL_RT_H1_RYRS.coms_auto));
            ...
            _this.addPoint(new meta_1.OpenCloseField("oc_jixiandishuiweibaojingdianji", 5, 2, "极限低水位报警电极", 0, ZH_CN_1.ZH_CN.coms_open_close));
            _this.addPoint(new meta_1.OpenCloseField("oc_dishuiweibaojingdianji_6dianjiteyou_", 5, 2, "低水位报警电极（6 电极特有）", 1, ZH_CN_1.ZH_CN.coms_open_close));
            ...
            _this.addPoint(new meta_1.OpenCloseField("oc_fuhediaojiekongzhi_yalikongzhiqifangshi_", 5, 2, "负荷调节控制（压力控制器方式）", 7, ZH_CN_1.ZH_CN.coms_open_close));
            _this.addPoint(new meta_1.OpenCloseField("oc_qitingkongzhi_yalikongzhiqifangshi_", 5, 2, "启停控制（压力控制器方式）", 8, ZH_CN_1.ZH_CN.coms_open_close));
            ...
            _this.addPoint(new meta_1.OpenCloseField("oc_ranqiyaliyichangbaojingxinhao", 5, 2, "燃气压力异常报警信号", 11, ZH_CN_1.ZH_CN.coms_open_close));
            ...
            _this.addPoint(new meta_1.OpenCloseField("oc_ranshaoqifuhediaojie/zengdadiaojie", 9, 2, "燃烧器负荷调节/增大调节", 1, ZH_CN_1.ZH_CN.coms_open_close));

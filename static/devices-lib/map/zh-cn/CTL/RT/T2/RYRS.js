...
module.exports = (_a = /** @class */ (function (_super) {
        ...
        function CTL_RT_T2_RYRS() {
            ...
            _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "工作状态", '', CTL_RT_T2_RYRS.coms_status));
            _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "累计燃烧时间", "时"));
            _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_T2_RYRS.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
            _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_T2_RYRS.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
            ...
            _this.addPoint(new meta_1.OpenCloseField("oc_chaoyabaojingxinhao", 5, 2, "超压报警", 9, ZH_CN_1.ZH_CN.coms_open_close));
            _this.addPoint(new meta_1.OpenCloseField("oc_ranshaoqiguzhangxinhao", 5, 2, "燃烧器故障信号", 10, ZH_CN_1.ZH_CN.coms_open_close));
            _this.addPoint(new meta_1.OpenCloseField("oc_ranqiyalidibaojingxinhao", 5, 2, "燃气压力低报警信号", 12, ZH_CN_1.ZH_CN.coms_open_close));
            _this.addPoint(new meta_1.OpenCloseField("oc_ranqixieloubaojingxinhao", 5, 2, "燃气泄漏报警信号", 11, ZH_CN_1.ZH_CN.coms_open_close));
            ...
            _this.addPoint(new meta_1.DeviceField("de_bushuibengzhubei", 49, 2, "补水泵", 0, CTL_RT_T2_RYRS.coms_master));
            _this.addPoint(new meta_1.DeviceField("de_bushuibengshoudongzidong", 49, 2, "补水泵", 1, CTL_RT_T2_RYRS.coms_auto));
            _this.addPoint(new meta_1.DeviceField("de_xunhuanbengzhubei", 49, 2, "循环泵", 2, CTL_RT_T2_RYRS.coms_master));
            _this.addPoint(new meta_1.DeviceField("de_xunhuanbengshoudongzidong", 49, 2, "循环泵", 3, CTL_RT_T2_RYRS.coms_auto));
            ...
            _this.addPoint(new meta_1.BaseInfoField("o_guoluleixing", 87, 2, "锅炉类型", '', CTL_RT_T2_RYRS.coms_guolu));
            _this.addPoint(new meta_1.BaseInfoField("o_ranshaoqigongzuofangshi", 89, 2, "燃烧器工作方式", '', CTL_RT_T2_RYRS.coms_ranshaoqi));
            _this.addPoint(new meta_1.BaseInfoField("o_bushuibengkongzhifangshi", 91, 2, "补水泵控制方式", '', CTL_RT_T2_RYRS.coms_bushuibeng));
            _this.addPoint(new meta_1.BaseInfoField("o_xunhuanbengkongzhifangshi", 93, 2, "循环泵控制方式", '', CTL_RT_T2_RYRS.coms_xunhuanbeng));
            return _this;
        }

...
module.exports = /** @class */ (function (_super) {
    __extends(CTL_RT_T2_RYZQ_YLBSQ_CK, _super);
    function CTL_RT_T2_RYZQ_YLBSQ_CK() {
        var _this = _super.call(this) || this;
        // this.warningMsg='';
        _this.addPoint(new meta_1.OpenCloseField("oc_queshuidianji2", 5, 2, "缺水电极2", 7, ZH_CN_1.ZH_CN.coms_open_close));
    ...
    return CTL_RT_T2_RYZQ_YLBSQ_CK;

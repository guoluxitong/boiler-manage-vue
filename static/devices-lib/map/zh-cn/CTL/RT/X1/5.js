...
module.exports = /** @class */ (function (_super) {
    ...
    function CTL_RT_X1_RYZQDJD() {
        ...
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态", '', CTL_RT_X1_RYZQDJD.coms_status));
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间", "时"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_RYZQDJD.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_RYZQDJD.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_RYZQDJD.KEY_BASE, 'ba_yalizhuangtai', "压力状态", ''));
        ...
        _this.addPoint(new meta_1.DeviceField("de_bushuibeng_shoudong/zidong_", 49, 2, "给水泵", 1, CTL_RT_X1_RYZQDJD.coms_auto));

...
module.exports = /** @class */ (function (_super) {
    __extends(CTL_RT_X1_RYRSGW2, _super);
    function CTL_RT_X1_RYRSGW2() {
        ...
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态", '', CTL_RT_X1_RYRSGW2.coms_status));
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间", "时"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_RYRSGW2.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_RYRSGW2.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        ...
        _this.addPoint(new meta_1.DeviceField("de_xunhuanbeng_zidong/shoudong_", 49, 2, "热水泵", 3, CTL_RT_X1_RYRSGW2.coms_auto));
        ...
        _this.addPoint(new meta_1.SettingField("se_zhuanhuowendu", 67, 2, "转火温度", "℃"));

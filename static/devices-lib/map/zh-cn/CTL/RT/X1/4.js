...
module.exports = /** @class */ (function (_super) {
    ...
    function CTL_RT_X1_DRS() {
        ...
        _this.addPoint(new CountField_1.CountField(RT_1.CTL_RT.KEY_POINT_Add_SHUI_BENG, "热水泵"));
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 3, 2, "控制器状态", '', CTL_RT_X1_DRS.coms_status));
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_LIFE, 53, 2, "运行时间", "时"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_DRS.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_DAYS, "运行天数", "天"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_DRS.KEY_BASE, SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_HOURS, "运行小时数", "时"));
        _this.addPoint(new CountShowField_1.CountShowField(CTL_RT_X1_DRS.KEY_BASE, 'ba_shuiweioryalizhuangtai', "水位(压力)状态", ''));
        ...
        _this.addPoint(new meta_1.DeviceField("de_xunhuanbeng_zidong/shoudong_", 49, 2, "热水泵", 3, CTL_RT_X1_DRS.coms_auto));
        ...
        _this.addPoint(new meta_1.OpenCloseField("oc_didianji/dianjiedianyalibiaodizhen", 5, 2, "低位电极/电接点压力表低针", 1, ZH_CN_1.ZH_CN.coms_open_close));
        _this.addPoint(new meta_1.OpenCloseField("oc_gaodianji/dianjiedianyalibiaogaozhen", 5, 2, "高位电极/电接点压力表高针", 2, ZH_CN_1.ZH_CN.coms_open_close));
        _this.addPoint(new meta_1.OpenCloseField("oc_bushuibengkongzhixinhao", 5, 2, "补水泵控制信号", 3, ZH_CN_1.ZH_CN.coms_open_close));
        _this.addPoint(new meta_1.OpenCloseField("oc_lubiwendukaiguan", 5, 2, "炉壁温度开关", 4, ZH_CN_1.ZH_CN.coms_open_close));
        _this.addPoint(new meta_1.OpenCloseField("oc_waibuliansuobaohu", 5, 2, "外部联锁保护", 5, ZH_CN_1.ZH_CN.coms_open_close));
        ...
        _this.addPoint(new meta_1.DeviceField(RT_1.CTL_RT.KEY_POINT_LENG_NING_BENG_1, 9, 2, "热水泵控制", 2, ZH_CN_1.ZH_CN.coms_open_close));

...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_YuReZhengQi() {
        ...
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 368, 2, "1#给水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_1, 370, 2, "1#给水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 372, 2, "2#给水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_2, 374, 2, "2#给水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_1_chuyangbeng_auto", 376, 2, "1#除氧泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_CHU_YANG_BENG_1, 378, 2, "1#除氧泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_chuyangbeng_auto", 380, 2, "2#除氧泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_CHU_YANG_BENG_2, 382, 2, "2#除氧泵", ZH_CN_1.ZH_CN.coms_start_stop));

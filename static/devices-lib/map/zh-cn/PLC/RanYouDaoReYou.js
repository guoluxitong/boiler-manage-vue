...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_RanYouDaoReYou() {
        ...
        _this.addPoint(new meta_1.DeviceField("de_1_xunhuanbeng_auto", 203, 2, "1#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_1, 205, 2, "1#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_xunhuanbeng_auto", 207, 2, "2#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_2, 209, 2, "2#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_3_xunhuanbeng_auto", 211, 2, "3#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_3, 213, 2, "3#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_zhuyoubeng_auto", 215, 2, "注油泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_ZHU_YOU_BENG_1, 217, 2, "注油泵", ZH_CN_1.ZH_CN.coms_start_stop));

...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_RanYouZhenKong() {
        ...
        _this.addPoint(new _485_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 13, 2, "系统状态", '', BaseMap_1.PLC.coms_status));
        ...
        _this.addPoint(new _485_1.BaseInfoField("ba_shuiweizhuangtai", 19, 2, "水位状态", '', ZH_CN_1.ZH_CN.coms_level));
        _this.addPoint(new _485_1.BaseInfoField("ba_ranshaoqizhuangtai", 21, 2, "燃烧器状态", '', BaseMap_1.PLC.coms_ranshaoqi_status));
        ...
        _this.addPoint(new meta_1.DeviceField("de_ranshaojiqiting", 163, 2, "燃烧器", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField("de_1_xunhuanbeng_auto", 165, 2, "1#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_1, 167, 2, "1#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_xunhuanbeng_auto", 169, 2, "2#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_2, 171, 2, "2#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 173, 2, "1#补水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_1, 175, 2, "1#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 177, 2, "2#补水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_2, 179, 2, "2#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_zhenkongbeng_auto", 181, 2, "真空泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_ZHEN_KONG_BENG_1, 183, 2, "真空泵", ZH_CN_1.ZH_CN.coms_start_stop));

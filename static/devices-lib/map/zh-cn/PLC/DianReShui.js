...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_DianReShui() {
        ...
        _this.addPoint(new meta_1.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 13, 2, "系统状态", '', BaseMap_1.PLC.coms_status));
        ...
        _this.addPoint(new meta_1.BaseInfoField("ba_ranshaoqizhuangtai", 21, 2, "燃烧器状态", '', BaseMap_1.PLC.coms_ranshaoqi_status));
        ...
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 199, 2, "1#补水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_1, 201, 2, "1#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 203, 2, "2#补水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_2, 205, 2, "2#补水泵", BaseMap_1.PLC.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_baojingshuchuzhishi", 207, 2, "报警输出指示", ZH_CN_1.ZH_CN.coms_open_close));
        _this.addPoint(new meta_1.DeviceField("de_1_xunhuanbeng_auto", 209, 2, "1#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_1, 211, 2, "1#循环泵", BaseMap_1.PLC.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_xunhuanbeng_auto", 213, 2, "2#循环泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_XUN_HUAN_BENG_2, 215, 2, "2#循环泵", BaseMap_1.PLC.coms_start_stop));

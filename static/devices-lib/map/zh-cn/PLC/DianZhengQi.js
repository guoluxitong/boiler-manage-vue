...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_DianZhengQi() {
        ...
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 199, 2, "1#给水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_1, 201, 2, "1#给水泵", BaseMap_1.PLC.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 203, 2, "2#给水泵", BaseMap_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(BaseDevice_1.PLC.KEY_POINT_Add_SHUI_BENG_2, 205, 2, "2#给水泵", BaseMap_1.PLC.coms_start_stop));

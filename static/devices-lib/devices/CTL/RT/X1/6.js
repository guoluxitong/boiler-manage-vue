...
module.exports = /** @class */ (function (_super) {
    __extends(CTL_RT_X1_RYZFHTJ, _super);
    function CTL_RT_X1_RYZFHTJ() {
        var _this = _super.call(this) || this;
        _this.BYTE_ARRAY_LENGTH = 111;
        return _this;
    }
    CTL_RT_X1_RYZFHTJ.prototype.getPowerInfo = function () {
    ...
    CTL_RT_X1_RYZFHTJ.prototype.addFocusFields = function (list) {
        var map = this.getBaseInfoFields();
        var field = map.getItem('ba_yalizhuangtai');
        var map2 = this.getOpenCloseFields();
        var n1 = map2.getItem('oc_fuhetiaojie').getValue() == 1 ? 2 : 0;
        var n2 = map2.getItem('oc_qitingkongzhi').getValue() == 1 ? 1 : 0;
        field.setValueString(X1_1.CTL_RT_X1_Ts.coms_fhtj_yl_status[n1 + n2]);
        var map3 = this.getMockFields();
        list.push(map3.getItem('mo_paiyanwendu'));
    };
    return CTL_RT_X1_RYZFHTJ;
}(RT_1.CTL_RT));

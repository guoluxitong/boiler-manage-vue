...
module.exports = (_a = /** @class */ (function (_super) {
        ...
        function CTL_RT_H1_RYRS() {
            ...
            _this.BYTE_ARRAY_LENGTH = 358;
            return _this;
        }
        CTL_RT_H1_RYRS.prototype.addFocusFields = function (list) {
        ...
        CTL_RT_H1_RYRS.prototype.getPowerInfo = function () {
    ...
    _a.KEY_POINT_RAN_SHAO_QI_STATUS = "oc_ranshaoqibilijianda",
    _a);

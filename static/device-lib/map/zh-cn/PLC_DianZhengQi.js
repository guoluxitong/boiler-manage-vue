...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_DianZhengQi() {
        ...
        _this.addPoint(new FixedValueField_1.FixedValueField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_MEDIA, "介质", 1, ZH_CN_1.ZH_CN.coms_media));
        ...
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 199, 2, "1#给水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_1, 201, 2, "1#给水泵", PLC_1.PLC.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 203, 2, "2#给水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_2, 205, 2, "2#给水泵", PLC_1.PLC.coms_start_stop));

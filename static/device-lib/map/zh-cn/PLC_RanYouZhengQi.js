...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_RanYouZhengQi() {
        ...
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_JIE_NENG_BENG, "节能泵"));
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_CHU_YANG_BENG, "除氧泵"));
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_ZHAO_QI_FAN, "沼气风机"));
        ...
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 368, 2, "1#补水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_1, 370, 2, "1#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 372, 2, "2#补水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_2, 374, 2, "2#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_1_jienengbeng_auto", 376, 2, "1#节能泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_JIE_NENG_BENG_1, 378, 2, "1#节能泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_jienengbeng_auto", 380, 2, "2#节能泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_JIE_NENG_BENG_2, 382, 2, "2#节能泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_1_chuyangbeng_auto", 384, 2, "1#除氧泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_CHU_YANG_BENG_1, 386, 2, "1#除氧泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_chuyangbeng_auto", 388, 2, "2#除氧泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_CHU_YANG_BENG_2, 390, 2, "2#除氧泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_baojingshuchuzhishi", 392, 2, "报警输出指示", ZH_CN_1.ZH_CN.coms_open_close));
        _this.addPoint(new meta_1.DeviceField("de_1_zhaoqifengji_auto", 394, 2, "1#沼气风机", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_ZHAO_QI_FAN_1, 396, 2, "1#沼气风机", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_zhaoqifengji_auto", 398, 2, "2#沼气风机", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_ZHAO_QI_FAN_2, 400, 2, "2#沼气风机启", ZH_CN_1.ZH_CN.coms_start_stop));

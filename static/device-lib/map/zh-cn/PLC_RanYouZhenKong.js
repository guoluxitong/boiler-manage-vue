...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_RanYouZhenKong() {
        ...
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG, "给水泵"));
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_XUN_HUAN_BENG, "循环泵"));
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_ZHEN_KONG_BENG, "真空泵"));
        _this.addPoint(new meta_2.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_HOURS, 9, 2, "运行小时数", "时"));
        _this.addPoint(new meta_2.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_RUN_DAYS, 11, 2, "运行天数", "天"));
        _this.addPoint(new meta_2.BaseInfoField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 13, 2, "系统状态", '', PLC_1.PLC.coms_status));
        _this.addPoint(new FixedValueField_1.FixedValueField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_POWER, "燃料", 0, ZH_CN_1.ZH_CN.coms_power));
        _this.addPoint(new FixedValueField_1.FixedValueField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_MEDIA, "介质", 4, ZH_CN_1.ZH_CN.coms_media));
        _this.addPoint(new meta_2.BaseInfoField("ba_shuiweizhuangtai", 19, 2, "水位状态", '', ZH_CN_1.ZH_CN.coms_level));
        _this.addPoint(new meta_2.BaseInfoField("ba_ranshaoqizhuangtai", 21, 2, "燃烧器状态", '', PLC_1.PLC.coms_ranshaoqi_status));
        ...
        _this.addPoint(new meta_1.DeviceField("de_ranshaojiqiting", 163, 2, "燃烧器", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField("de_1_xunhuanbeng_auto", 165, 2, "1#循环泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_XUN_HUAN_BENG_1, 167, 2, "1#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_xunhuanbeng_auto", 169, 2, "2#循环泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_XUN_HUAN_BENG_2, 171, 2, "2#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 173, 2, "1#补水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_1, 175, 2, "1#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 177, 2, "2#补水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_2, 179, 2, "2#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_zhenkongbeng_auto", 181, 2, "真空泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_ZHEN_KONG_BENG_1, 183, 2, "真空泵", ZH_CN_1.ZH_CN.coms_start_stop));

...
module.exports = /** @class */ (function (_super) {
    ...
    function PLC_RanYouReShui() {
        ...
        _this.addPoint(new CountField_1.CountField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG, "补水泵"));
        ...
        _this.addPoint(new FixedValueField_1.FixedValueField(SdcSoftDevice_1.SdcSoftDevice.KEY_POINT_MEDIA, "介质", 0, ZH_CN_1.ZH_CN.coms_media));
        ...
        _this.addPoint(new meta_1.DeviceField("de_ranshaoqiqiting", 368, 2, "燃烧器", PLC_1.PLC.coms_ranshaoqi_status));
        _this.addPoint(new meta_1.DeviceField("de_1_addshuibeng_auto", 370, 2, "1#补水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_1, 372, 2, "1#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_addshuibeng_auto", 374, 2, "2#补水泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_Add_SHUI_BENG_2, 376, 2, "2#补水泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_1_xunhuanbeng_auto", 378, 2, "1#循环泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_XUN_HUAN_BENG_1, 380, 2, "1#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));
        _this.addPoint(new meta_1.DeviceField("de_2_xunhuanbeng_auto", 382, 2, "2#循环泵", PLC_1.PLC.coms_atuo));
        _this.addPoint(new meta_1.DeviceField(PLC_2.PLC.KEY_POINT_XUN_HUAN_BENG_2, 384, 2, "2#循环泵", ZH_CN_1.ZH_CN.coms_start_stop));

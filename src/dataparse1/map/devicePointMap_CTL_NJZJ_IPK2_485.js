...
import { deviceModel, commandsMap } from '../model/sdcSoftDevice'
...
import runHousField from "../meta/runHousField"
...
export default class devicePointMap_CTL_NJZJ_IPK2_485 extends map {
  constructor() {
    ...
    commandsMap[Commands_Key_Parameters_Setting] = null;
    commandsMap[Commands_Key_System_Ctl] = null;

...
export default class devicePointMap_CTL_NJZJ_IP_485 extends map{
  constructor() {
    super();
    ...
    this.getPointMap[deviceModel.key_point_run_hours]=byteFieldObj.init(new baseInfoField(), deviceModel.key_point_run_hours, "运行小时数", "时")

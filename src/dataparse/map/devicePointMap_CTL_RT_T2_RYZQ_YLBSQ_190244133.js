...
export default class devicePointMap_CTL_RT_T2_RYZQ_YLBSQ_190244133 extends map {
  constructor () {
    super();
    ...
    this.getPointMap["oc_yalikongzhiqi1"]=byteFieldObj.init(new openCloseField(), "oc_yalikongzhiqi1", 5, 2, "压力控制器（一段火）",7,coms_open_close)
    this.getPointMap["oc_yalikongzhiqi2"]=byteFieldObj.init(new openCloseField(), "oc_yalikongzhiqi2", 5, 2, "压力控制器（二段火）",8,coms_open_close)
    ...
    this.getPointMap["oc_ranshaoqifuhetiaojie"]=byteFieldObj.init(new openCloseField(), "oc_ranshaoqifuhetiaojie", 0, 0, "燃烧器调节",ctl_njrt_common_valueMap.coms_ranshaoqi_status)
    ...
    this.getPointMap["oc_1_lengningxunhuanbeng_start_stop"] = byteFieldObj.init(new deviceField(), "oc_1_lengningxunhuanbeng_start_stop", 9, 2, "节能循环泵控制",5,coms_open_close)
    ...
    this.getPointMap["ex_ranqiyaligaobaojing"]=byteFieldObj.init(new exceptionField(),"ex_ranqiyaligaobaojing", 47, 2, "燃气压力高报警",0)
    this.getPointMap["ex_ranqixieloubaojing"]=byteFieldObj.init(new exceptionField(),"ex_ranqixieloubaojing", 47, 2, "燃气泄漏报警",1)
    this.getPointMap["ex_ranshaoqiguzhang"]=byteFieldObj.init(new exceptionField(),"ex_ranshaoqiguzhang", 47, 2, "燃烧器故障",2)
  }
}

...
export default class devicePointMap_CTL_HNWE_485 extends map{
 ...
 //
        ...
        this.getPointMap["mo_shedingzhi"]=byteFieldObj.init(new settingField(), "mo_shedingzhi", 22, 2, "设定值","")
        ...
        this.getPointMap["mo_CHzuidashedingzhi"]=byteFieldObj.init(new settingField(), "mo_CHzuidashedingzhi", 52, 2, "CH最大设定值","")

...
export default class devicePointMap_CTL_RT_T3_RYZQ_YLBSQ extends map {
  constructor () {
    super();
    ...
    this.getPointMap["oc_ranshaoqiqitingkongzhi"]=byteFieldObj.init(new openCloseField(), "oc_ranshaoqiqitingkongzhi", 9, 2, "燃烧器启停控制",coms_open_close)
    ...
    this.getPointMap["de_lengningxunhuanbeng_zidong/shoudong_"] = byteFieldObj.init(new deviceField(), "de_lengningxunhuanbeng_zidong/shoudong_", 49, 2, "冷凝循环泵",3, ctl_njrt_common_valueMap.coms_master)

...
export default class devicePointMap_CTL_RT_T2_RYZQ_YLKZQ_190244133 extends map {
  constructor () {
    super();
    const coms_status = {
      0: '待命',
    ...
    this.getPointMap["oc_baojingzhuangtaishuchu"] = byteFieldObj.init(new deviceField(), "oc_baojingzhuangtaishuchu", 9, 2, "节能循环泵控制",5,coms_open_close)

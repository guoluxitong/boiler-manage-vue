<template>
  <div class="app-container auxiliaryMachineLargeClass-container">
    ...
    <el-table
      ...
      @row-dblclick="handleAddAuxiliaryMachineSmallClassList"
      border
      fit
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="30%">
      <el-form
        :rules="rules"
        ref="auxiliaryMachineLargeClassForm"
        :model="auxiliaryMachineLargeClassFormData"
...
export default {
  ...
  methods: {
    ...
    handleAddAuxiliaryMachineSmallClassList(row) {
      this.$router.push({
        path: "/auxiliary-machine-small-class",
        query: { largeClassId: row.id }
      });
    },
